...
dataset_path=os.path.join(file_dir,"input/0622_large-dataset_v1.csv") #测试数据集
embed_stru_path=os.path.join(file_dir,"input/0622-embed_v1/") #测试embed
# dataset_path="input/0622_large-dataset_v1.csv"
# embed_stru_path="input/0622-embed_v1/"
...
print("===="*4)
task_id="demo2_0-largedata-with_similar_stru" #代表对应任务名
